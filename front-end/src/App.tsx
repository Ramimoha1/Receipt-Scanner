              ...
              {viewMode === 'SCAN' ? (
                <div className="max-w-3xl mx-auto w-full">
                    <div className="text-center mb-8">
                      <h1 className="text-3xl font-bold text-slate-900 mb-2">Manual Receipt Entry</h1>
                      <p className="text-slate-500">Upload an image, fill the fields, and save it directly to the database.</p>
                    </div>
